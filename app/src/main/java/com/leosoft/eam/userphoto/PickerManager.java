...
public abstract  class PickerManager {
    ...
    private UCrop uCrop;
    protected com.leosoft.eam.userphoto.PickerBuilder.onImageReceivedListener imageReceivedListener;
    protected com.leosoft.eam.userphoto.PickerBuilder.onPermissionRefusedListener permissionRefusedListener;
    private int cropActivityColor = R.color.colorPrimary;
    public PickerManager setOnImageReceivedListener(com.leosoft.eam.userphoto.PickerBuilder.onImageReceivedListener listener) {
        this.imageReceivedListener = listener;
        return this;
    }

    public PickerManager setOnPermissionRefusedListener(com.leosoft.eam.userphoto.PickerBuilder.onPermissionRefusedListener listener) {
    ...
    protected Uri getImageFile(boolean flagFileProvider)
    {
        ...
        if (flagFileProvider) {
            return FileProvider.getUriForFile(activity, "com.leosoft.eam.fileprovider", photo);
        }
    ...
    public void startCropActivity()
    {
        if(uCrop == null)
        {
            uCrop = UCrop.of(mProcessingPhotoUri, getImageFile(false));
            ...
            options.setToolbarColor(Color.rgb(25,169,147));
            options.setStatusBarColor(Color.rgb(20,135,118));
            options.setActiveWidgetColor(Color.rgb(25,169,147));
